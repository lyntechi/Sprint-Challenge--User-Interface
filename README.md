...
HTML gives your content meaning and is very important to keep it that way for screen reader purposes and search engines to provide a better understanding.

2. What are the 4 areas of the box model? content, padding, border, margin

3. While using flexbox, what axis does the following property work on: ```align-items: center```? items along the cross axis


4. Explain why git is valuable to a team of developers.
to be able to colloborate with others working on the same project.

5. Define mobile-first design in your own words.
setting up meto view port to be able to apply media query rules so that your website
contents arent everywhere when viewing on mobile.
